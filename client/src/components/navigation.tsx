          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-coral to-sunny text-white px-6 py-3 rounded-full font-semibold hover:scale-105 transition-transform duration-200 shadow-lg"
              >
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="flex flex-col space-y-3">
              ...
              <Button 
                onClick={() => scrollToSection('contact')}
                className="bg-gradient-to-r from-coral to-sunny text-white mx-4 rounded-full font-semibold"
              >
                Contact for Wholesale
              </Button>
            </div>
